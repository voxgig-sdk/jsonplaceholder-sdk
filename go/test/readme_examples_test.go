...
const testSeed = `map[string]any{"entity": map[string]any{"album": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "comment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "photo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "todo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
