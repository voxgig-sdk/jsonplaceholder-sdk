...
func NewAlbumEntity(client *core.JsonplaceholderSDK, entopts map[string]any) *AlbumEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AlbumEntity) GetName() string { return e.name }
...
func (e *AlbumEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AlbumEntity) Deleted() bool {
	return e.deleted
}


func (e *AlbumEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAlbumEntity(e.client, opts)
}

func (e *AlbumEntity) Data(args ...any) any {
...
func (e *AlbumEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AlbumEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AlbumEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *AlbumEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *AlbumEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
func (e *AlbumEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
func (e *AlbumEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
