...
func NewTodoEntity(client *core.JsonplaceholderSDK, entopts map[string]any) *TodoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TodoEntity) GetName() string { return e.name }
...
func (e *TodoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TodoEntity) Deleted() bool {
	return e.deleted
}


func (e *TodoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTodoEntity(e.client, opts)
}

func (e *TodoEntity) Data(args ...any) any {
...
func (e *TodoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TodoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TodoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *TodoEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *TodoEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
func (e *TodoEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
func (e *TodoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
