...
type PhotoEntity struct {
	name    string
	client  *core.JsonplaceholderSDK
...
func NewPhotoEntity(client *core.JsonplaceholderSDK, entopts map[string]any) *PhotoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PhotoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PhotoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PhotoListMatch and returns []Photo. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PhotoEntity) ListTyped(reqmatch PhotoListMatch, ctrl map[string]any) ([]Photo, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Photo](res), nil
}




func (e *PhotoEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PhotoCreateData and returns an Photo. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PhotoEntity) CreateTyped(reqdata PhotoCreateData, ctrl map[string]any) (Photo, error) {
...
func (e *PhotoEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// PhotoUpdateData and returns an Photo. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *PhotoEntity) UpdateTyped(reqdata PhotoUpdateData, ctrl map[string]any) (Photo, error) {
...
func (e *PhotoEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PhotoRemoveMatch and returns an Photo. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PhotoEntity) RemoveTyped(reqmatch PhotoRemoveMatch, ctrl map[string]any) (Photo, error) {
