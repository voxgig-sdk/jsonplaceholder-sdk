...
func registerSDKWords(r *eng.Registry, client *sdk.JsonplaceholderSDK) {
...
func runOp(client *sdk.JsonplaceholderSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
