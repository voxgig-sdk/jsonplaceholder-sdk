...
|---|---|---|
| `ts/` | @voxgig-sdk/jsonplaceholder-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/jsonplaceholder-sdk \
      --repository voxgig-sdk/jsonplaceholder-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/jsonplaceholder-sdk` shows it, and
`npm trust revoke @voxgig-sdk/jsonplaceholder-sdk --id=<id>` removes it.
