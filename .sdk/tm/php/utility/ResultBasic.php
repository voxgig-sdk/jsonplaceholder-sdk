...
// Jsonplaceholder SDK utility: result_basic

class JsonplaceholderResultBasic
{
    public static function call(JsonplaceholderContext $ctx): ?JsonplaceholderResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof JsonplaceholderError) ? $result->err->msg : (string)$result->err;
