...
// Jsonplaceholder SDK utility: graphql
//
...
class JsonplaceholderGraphql
{
    ...
    // equivalent.
    public static function body(JsonplaceholderContext $ctx): mixed
    {
    ...
    public static function errors(JsonplaceholderContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
