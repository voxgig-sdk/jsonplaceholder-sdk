...
// Jsonplaceholder SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = JsonplaceholderOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(JsonplaceholderOmni::structfix($now, Struct::undef()))
                        !== json_encode(JsonplaceholderOmni::structfix($val, Struct::undef()))) {
