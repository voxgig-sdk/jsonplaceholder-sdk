...
// Jsonplaceholder SDK timeout feature
...
class JsonplaceholderTimeoutFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _with_timeout(JsonplaceholderContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JsonplaceholderContext $_ctx, float $ms): void
    {
        $client = $this->client;
