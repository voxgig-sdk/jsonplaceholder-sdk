...
// Jsonplaceholder SDK cache feature
...
class JsonplaceholderCacheFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _through(JsonplaceholderContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
