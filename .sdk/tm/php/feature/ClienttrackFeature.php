...
// Jsonplaceholder SDK clienttrack feature
...
class JsonplaceholderClienttrackFeature extends JsonplaceholderBaseFeature
{
    ...
    public function PostConstruct(JsonplaceholderContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Jsonplaceholder-SDK';
