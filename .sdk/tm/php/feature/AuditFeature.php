...
// Jsonplaceholder SDK audit feature
...
class JsonplaceholderAuditFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _emit(JsonplaceholderContext $ctx, string $outcome): void
    {
