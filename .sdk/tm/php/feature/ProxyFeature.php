...
// Jsonplaceholder SDK proxy feature
...
class JsonplaceholderProxyFeature extends JsonplaceholderBaseFeature
{
    ...
    public function init(JsonplaceholderContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (JsonplaceholderContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
