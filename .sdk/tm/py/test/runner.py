...
class JsonplaceholderTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JsonplaceholderTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = JsonplaceholderTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = JsonplaceholderTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
