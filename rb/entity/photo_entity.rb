...
class PhotoEntity
  ...
  #   as an empty match, so client.Photo.load works with no args).
  ...
  #
  # @param reqmatch [PhotoListMatch, Hash, nil] match filter (any subset of
  #   Photo fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
