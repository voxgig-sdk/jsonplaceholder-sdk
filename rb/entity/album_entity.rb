...
class AlbumEntity
  ...
  #   as an empty match, so client.Album.load works with no args).
  ...
  #
  # @param reqmatch [AlbumListMatch, Hash, nil] match filter (any subset of
  #   Album fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
