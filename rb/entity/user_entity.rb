# Jsonplaceholder SDK User entity
...
class UserEntity
  ...
  # @return [User, Hash] the loaded User; raises JsonplaceholderError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<User>, Array] the matching User items; raises JsonplaceholderError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the created User; raises JsonplaceholderError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the updated User; raises JsonplaceholderError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the removed User; raises JsonplaceholderError on failure
