...
module JsonplaceholderTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("JSONPLACEHOLDER_TEST_LIVE")
    override = getenv("JSONPLACEHOLDER_TEST_OVERRIDE")
    ...
    explain = getenv("JSONPLACEHOLDER_TEST_EXPLAIN")
    m["JSONPLACEHOLDER_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = JsonplaceholderTestRunner
Helpers = JsonplaceholderHelpers
Vs = VoxgigStruct
