...
#      offline in seeded test mode (JsonplaceholderSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Jsonplaceholder_sdk.rb")
  SDK_CLASS = "JsonplaceholderSDK"
