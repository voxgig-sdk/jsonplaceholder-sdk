...
type Args struct {
	Entity string         `json:"entity" jsonschema:"album | comment | photo | post | todo | user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.JsonplaceholderSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "jsonplaceholder_list",
		Description: "List records from Jsonplaceholder. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "jsonplaceholder_load",
		Description: "Load a single record from Jsonplaceholder. " +
...
func runOp(client *sdk.JsonplaceholderSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.JsonplaceholderSDK, name string) (sdk.JsonplaceholderEntity, error) {
	switch strings.ToLower(name) {
	case "album":
		return client.Album(nil), nil
	case "comment":
