// Command Jsonplaceholder-mcp is an MCP server exposing the Jsonplaceholder
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Jsonplaceholder_list  — list records of an entity
//	Jsonplaceholder_load  — load a single record of an entity
//
