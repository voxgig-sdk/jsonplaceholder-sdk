...
class AlbumEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AlbumEntity($this->_client, $opts);
    }

    /**
     * @param Album|array $args Album data (assoc-array) to store.
     */
    ...
    /**
     * @return Album|array The current Album data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Album fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Album fields).
     */
     ...
     * Load a single Album.
     *
     * @param AlbumLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AlbumLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Album|array The loaded Album as an assoc-array at the
     ...
     *
     * @param AlbumListMatch|array|null $reqmatch Match filter (any subset
     *   of Album fields) as an assoc-array; AlbumListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Album[]|array A list of Album items as assoc-arrays at
     ...
     * Create a new Album.
     *
     * @param AlbumCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AlbumCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Album|array The created Album as an assoc-array at the
     *   SDK boundary; throws JsonplaceholderError on failure (item-5 convention).
     */
     ...
     *
     * @param AlbumUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AlbumUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Album|array The updated Album as an assoc-array at the
     *   SDK boundary; throws JsonplaceholderError on failure (item-5 convention).
     */
     ...
     *
     * @param AlbumRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AlbumRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Album|array The removed Album as an assoc-array at the
     *   SDK boundary; throws JsonplaceholderError on failure (item-5 convention).
     */
