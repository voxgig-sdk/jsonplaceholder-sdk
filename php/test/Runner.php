...
class JsonplaceholderTestRunner
{
    ...
    {
        $live = self::getenv('JSONPLACEHOLDER_TEST_LIVE');
        $override = self::getenv('JSONPLACEHOLDER_TEST_OVERRIDE');
        ...
        $explain = self::getenv('JSONPLACEHOLDER_TEST_EXPLAIN');
...
class_alias('JsonplaceholderTestRunner', 'Runner');
class_alias('JsonplaceholderHelpers', 'Helpers');
