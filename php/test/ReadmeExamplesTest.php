...
// Jsonplaceholder SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JsonplaceholderSDK::test)
...
{
    private const SDK_CLASS = 'JsonplaceholderSDK';
    ...
    private const SDK_BASE = 'jsonplaceholder_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../jsonplaceholder_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
