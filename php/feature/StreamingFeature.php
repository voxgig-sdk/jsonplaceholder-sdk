...
// Jsonplaceholder SDK streaming feature
...
class JsonplaceholderStreamingFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _iterate(JsonplaceholderResult $result): \Generator
    {
    ...
    private function _streamable(JsonplaceholderContext $ctx): bool
    {
