...
// Jsonplaceholder SDK metrics feature
...
class JsonplaceholderMetricsFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _record(JsonplaceholderContext $ctx, bool $ok): void
    {
