...
// Jsonplaceholder SDK ratelimit feature
...
class JsonplaceholderRatelimitFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _acquire(JsonplaceholderContext $ctx): void
    {
    ...
    private function _track(JsonplaceholderContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
