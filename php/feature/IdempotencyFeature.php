...
// Jsonplaceholder SDK idempotency feature
...
class JsonplaceholderIdempotencyFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _mutating(JsonplaceholderContext $ctx): bool
    {
