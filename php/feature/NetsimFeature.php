...
// Jsonplaceholder SDK netsim feature
...
class JsonplaceholderNetsimFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _simulate(JsonplaceholderContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(JsonplaceholderContext $ctx, array $applied): void
    {
        $client = $this->client;
