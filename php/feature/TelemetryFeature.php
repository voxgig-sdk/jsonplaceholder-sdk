...
// Jsonplaceholder SDK telemetry feature
...
class JsonplaceholderTelemetryFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _close(JsonplaceholderContext $ctx, bool $ok): void
    {
