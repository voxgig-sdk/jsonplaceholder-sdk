...
// Jsonplaceholder SDK rbac feature
...
class JsonplaceholderRbacFeature extends JsonplaceholderBaseFeature
{
    ...
    private function _required(JsonplaceholderContext $ctx): ?string
    {
    ...
    private function _reject(JsonplaceholderContext $ctx, string $required): void
    {
    ...
    private function _track(JsonplaceholderContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
