...
// Jsonplaceholder SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class JsonplaceholderTransformResponse
{
    public static function call(JsonplaceholderContext $ctx): mixed
    {
        ...
        $transform = JsonplaceholderHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
