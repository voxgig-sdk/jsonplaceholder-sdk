...
// Jsonplaceholder SDK utility: fetcher
...
class JsonplaceholderFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JsonplaceholderSDK/1.0)';
    ...
    public static function call(JsonplaceholderContext $ctx, string $fullurl, array $fetchdef): array
    {
