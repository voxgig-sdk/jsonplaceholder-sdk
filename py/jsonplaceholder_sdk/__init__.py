...
from jsonplaceholder_sdk.utility import register

# Load features
from jsonplaceholder_sdk.feature.base_feature import JsonplaceholderBaseFeature
from jsonplaceholder_sdk.features import _has_feature, _make_feature
...
class JsonplaceholderSDK:
    ...
    def get_utility(self):
        return JsonplaceholderUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JsonplaceholderSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Album(self, data=None) -> "AlbumEntity":
        ...
        from jsonplaceholder_sdk.entity.album_entity import AlbumEntity
