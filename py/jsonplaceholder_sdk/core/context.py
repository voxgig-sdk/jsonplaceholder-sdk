...
from jsonplaceholder_sdk.core.helpers import get_ctx_prop, to_map
...
class JsonplaceholderContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = JsonplaceholderControl()
        ...
        if isinstance(sp, JsonplaceholderSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, JsonplaceholderResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, JsonplaceholderResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return JsonplaceholderOperation({})
    ...
    def make_error(self, code, msg):
        return JsonplaceholderError(code, msg, self)
