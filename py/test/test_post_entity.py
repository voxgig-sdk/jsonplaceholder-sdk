    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set JSONPLACEHOLDER_TEST_POST_ENTID JSON to run live")
        client = setup["client"]
        ...
        post_ref01_data = helpers.to_map(runner.entity_data(post_ref01_ent.create(post_ref01_data, None)))
        ...
        post_ref01_markdef_up0_name = "body"
        ...
        post_ref01_resdata_up0 = helpers.to_map(runner.entity_data(post_ref01_ent.update(post_ref01_data_up0_up, None)))
...
def _post_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "JSONPLACEHOLDER_TEST_POST_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("JSONPLACEHOLDER_TEST_POST_ENTID"))
