# Jsonplaceholder SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JsonplaceholderSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JsonplaceholderSDK(...) and JsonplaceholderSDK.test(...) become
#      JsonplaceholderSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "jsonplaceholder_sdk"
_SDK_CLASS = "JsonplaceholderSDK"
