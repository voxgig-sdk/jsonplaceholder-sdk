...
local SDK_MODULE = "jsonplaceholder_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["album"] = { ["test01"] = { id = "test01" } }, ["comment"] = { ["test01"] = { id = "test01" } }, ["photo"] = { ["test01"] = { id = "test01" } }, ["post"] = { ["test01"] = { id = "test01" } }, ["todo"] = { ["test01"] = { id = "test01" } }, ["user"] = { ["test01"] = { id = "test01" } } } }'
