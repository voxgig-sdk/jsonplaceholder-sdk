...
function envOverride(m) {
    if ('TRUE' === process.env.JSONPLACEHOLDER_TEST_LIVE ||
        'TRUE' === process.env.JSONPLACEHOLDER_TEST_OVERRIDE) {
    ...
    m.JSONPLACEHOLDER_TEST_EXPLAIN = process.env.JSONPLACEHOLDER_TEST_EXPLAIN || m.JSONPLACEHOLDER_TEST_EXPLAIN;
    return m;
}
