...
(0, node_test_1.describe)('PhotoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.JsonplaceholderSDK({
    ...
    (0, node_test_1.test)('direct-load-photo', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-photo', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-photo', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-photo', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["album01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.JsonplaceholderSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['JSONPLACEHOLDER_TEST_PHOTO_ENTID'];
    ...
    const client = new __1.JsonplaceholderSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PhotoDirect.test.js.map