...
(0, node_test_1.describe)('TodoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-todo', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-todo', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-todo', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-todo', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JSONPLACEHOLDER_TEST_TODO_ENTID'];
...
//# sourceMappingURL=TodoDirect.test.js.map