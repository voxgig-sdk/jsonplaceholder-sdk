...
(0, node_test_1.describe)('CommentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-comment', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-comment', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-comment', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-comment', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JSONPLACEHOLDER_TEST_COMMENT_ENTID'];
...
//# sourceMappingURL=CommentDirect.test.js.map