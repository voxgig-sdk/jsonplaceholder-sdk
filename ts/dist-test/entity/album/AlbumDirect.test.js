...
(0, node_test_1.describe)('AlbumDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-album', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-album', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-album', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-album', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['JSONPLACEHOLDER_TEST_ALBUM_ENTID'];
...
//# sourceMappingURL=AlbumDirect.test.js.map