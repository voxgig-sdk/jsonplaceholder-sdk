...
class AlbumEntity extends JsonplaceholderEntityBase<Album> {
  ...
  make(this: AlbumEntity) {
    return new AlbumEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AlbumLoadMatch, ctrl?: Control): Promise<AlbumEntity> {
  ...
  async list(this: any, reqmatch?: AlbumListMatch, ctrl?: Control): Promise<AlbumEntity[]> {
  ...
  async create(this: any, reqdata?: AlbumCreateData, ctrl?: Control): Promise<AlbumEntity> {
  ...
  async update(this: any, reqdata?: AlbumUpdateData, ctrl?: Control): Promise<AlbumEntity> {
  ...
  async remove(
    this: any, reqmatch?: AlbumRemoveMatch, ctrl?: Control,
  ): Promise<AlbumEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<AlbumEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
