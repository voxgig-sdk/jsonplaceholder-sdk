...
class TodoEntity extends JsonplaceholderEntityBase<Todo> {
  ...
  make(this: TodoEntity) {
    return new TodoEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: TodoLoadMatch, ctrl?: Control): Promise<TodoEntity> {
  ...
  async create(this: any, reqdata?: TodoCreateData, ctrl?: Control): Promise<TodoEntity> {
  ...
  async update(this: any, reqdata?: TodoUpdateData, ctrl?: Control): Promise<TodoEntity> {
  ...
  async remove(
    this: any, reqmatch?: TodoRemoveMatch, ctrl?: Control,
  ): Promise<TodoEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<TodoEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
