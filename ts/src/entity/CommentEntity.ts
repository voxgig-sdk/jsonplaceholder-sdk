...
class CommentEntity extends JsonplaceholderEntityBase<Comment> {
  ...
  make(this: CommentEntity) {
    return new CommentEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: CommentLoadMatch, ctrl?: Control): Promise<CommentEntity> {
  ...
  async list(this: any, reqmatch?: CommentListMatch, ctrl?: Control): Promise<CommentEntity[]> {
  ...
  async create(this: any, reqdata?: CommentCreateData, ctrl?: Control): Promise<CommentEntity> {
  ...
  async update(this: any, reqdata?: CommentUpdateData, ctrl?: Control): Promise<CommentEntity> {
  ...
  async remove(
    this: any, reqmatch?: CommentRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CommentEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
