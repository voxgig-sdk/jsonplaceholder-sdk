...
class PostEntity extends JsonplaceholderEntityBase<Post> {
  ...
  async create(this: any, reqdata?: PostCreateData, ctrl?: Control): Promise<PostEntity> {
  ...
  async update(this: any, reqdata?: PostUpdateData, ctrl?: Control): Promise<PostEntity> {
  ...
  async remove(
    this: any, reqmatch?: PostRemoveMatch, ctrl?: Control,
  ): Promise<PostEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<PostEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
