...
class JsonplaceholderSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('JsonplaceholderSDK: graphql: ' +
  ...
  Album(entopts?: Record<string, any>) {
    const self = this
    return new AlbumEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Todo(entopts?: Record<string, any>) {
    const self = this
    return new TodoEntity(self, entopts)
  }
