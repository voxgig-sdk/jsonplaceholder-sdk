...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/jsonplaceholder` | `npm install @voxgig-sdk/jsonplaceholder` |
| Python | `voxgig-sdk-jsonplaceholder` | `pip install voxgig-sdk-jsonplaceholder` |
| PHP | `voxgig-sdk/jsonplaceholder` | `composer require voxgig-sdk/jsonplaceholder` |
| Golang | `github.com/voxgig-sdk/jsonplaceholder-sdk/go` | `go get github.com/voxgig-sdk/jsonplaceholder-sdk/go` |
| Ruby | `voxgig-sdk-jsonplaceholder` | `gem install voxgig-sdk-jsonplaceholder` |
| Lua | `voxgig-sdk-jsonplaceholder` | `luarocks install voxgig-sdk-jsonplaceholder` |
